...
const SESSION_LANGUAGE_OPTIONS: Array<{ value: SessionLanguage; label: string }> = [
  ...
  { value: 'es-US', label: 'Spanish (es-US)' },
];
  ...
  return (
    <div className={'mx-auto grid w-full max-w-3xl gap-4 ' + (className ?? '')}>
      <Card className="border-[#FDE3CC] bg-[#FFFBF5]">
        <CardPanel className="flex flex-col items-center gap-6 p-6">
...
function PreCallConfig({
  ...
  return (
    ...
    >
      ...
      <CardPanel className="flex flex-col gap-5 pb-8 pt-4">
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
          <div className="flex flex-col gap-1.5">
            ...
            <Select
              items={SESSION_LANGUAGE_OPTIONS}
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <Select
              items={SESSION_OPTIMIZE_OPTIONS}
