...
def format_index() -> str:
    ...
    lines: list[str] = [
        ...
        (
            ...
            "`resources/read` on this MCP server. Prefer "
            "`spekoai://docs/llms-full` first for current SDK, API, and "
            "guide details generated from docs.speko.dev. "
            "`spekoai://docs/llms` is the compact index; READMEs are "
