...
def register_resources(mcp: FastMCP) -> None:
    @mcp.resource(
        ...
        description=(
            "Index of every bundled SpekoAI doc: hosted llms.txt exports, "
            "SDKs, adapters, platform overview, quickstart, and migration "
            "guides. Read this first to find the right resource for any "
            "SpekoAI question."
        ),
    ...
    @mcp.resource(
        ...
        name="docs",
        description=(
            "SpekoAI documentation by slug. Call spekoai://docs/index for the list of valid slugs."
        ),
        mime_type="text/markdown",
    )
    def doc(slug: str) -> str:
        try:
            ...
            raise ResourceError(f"unknown doc slug: {slug!r}. Valid slugs: {slugs}") from None
