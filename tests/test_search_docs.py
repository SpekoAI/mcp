...
@pytest.mark.parametrize(
    ...
    [
        ("VoiceConversation", "llms-full"),
        ("createSpekoComponents", "llms-full"),
        ("AsyncSpeko", "llms-full"),
    ],
)
def test_seeded_queries_return_expected_top_slug(query: str, expected_top_slug: str) -> None:
